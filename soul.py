...
FORWARD_CHANNEL_ID = -1002217601418
CHANNEL_ID = -1002217601418
error_channel_id = -1002217601418
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @Owner_Rockybhai.*", parse_mode='Markdown')  # Contact owner message
            return
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO THE ROCKY SERVER!* 🎉\n\n"
